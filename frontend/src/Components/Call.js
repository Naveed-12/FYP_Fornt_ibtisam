...
function Call() {
  ...
  return (
    <div className="call_container">
      <p
        className="call_container_price"
      ...
      <div className="call_btn">
        <img src={call} />
        <span style={{ cursor: "pointer" }}>Call</span>
      </div>
      <form>
        ...
        <div className="form_text">
          <label>Message</label>
          <br />
          <textarea rows="4" cols="22" id="input3" />
        </div>
        <p
          className="option_para"
          style={{ fontFamily: "Verdana, Geneva, Tahoma, sans-serif" }}
        >
          I am a:
        </p>
        <div className="form_option" style={{ marginTop: "10px" }}>
          <div className="option">
            <label for="vehicle1">Buyer</label>
            <input type="checkbox" />
          </div>
          <div className="option">
            <label for="vehicle1">Agent</label>
            <input type="checkbox" />
          </div>
          <div className="option">
